 ...
 * @TODO: Do this in .info once https://drupal.org/node/575298 is committed.
 */
...
function rubik_preprocess_page(&$vars) {
  ...
  if (!function_exists('tao_theme') && user_access('administer site configuration')) {
    drupal_set_message(t('The Rubik theme requires the !tao base theme in order to work properly.', array('!tao' => l('Tao', 'https://drupal.org/project/tao'))), 'warning');
  }
