...
function zen_form_system_theme_settings_alter(&$form, $form_state, $form_id = NULL) {
  ...
  $form['themedev']['zen_wireframes'] = array(
    ...
    '#description'   => t('<a href="!link">Wireframes</a> are useful when prototyping a website.', array('!link' => 'https://www.boxesandarrows.com/view/html_wireframes_and_prototypes_all_gain_and_no_pain')),
  );
}
